...
```
## Model comparison: six-model LOO
All six models share the same dataset (data_3, 20 items) and the same 
4-category response variable, making LOO-CV comparison valid.
...
# Direct comparison within the GRM family
model_weights(ct_grm_20, bf_grm_20)

```

# Final model Wright map
```{r}
